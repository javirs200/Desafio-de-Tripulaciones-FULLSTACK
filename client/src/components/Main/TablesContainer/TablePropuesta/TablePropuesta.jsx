...
const TablePropuesta = ({
  ...
  useEffect(() => {
    ...
    totalPagoFactura_prop,
    totalPagoFacturaPotencia_prop,
    valorOtrosMes,
    restoDeCampos,
    impuestoElectrico_prop,
  ]);
  ...
  useEffect(() => {
    setPrecioDescuento_prop({
      p1:
        preciosPropuesta.p1_e - preciosPropuesta.p1_e * (descuento_prop / 100),
      p2:
        preciosPropuesta.p2_e - preciosPropuesta.p2_e * (descuento_prop / 100),
      p3:
        preciosPropuesta.p3_e - preciosPropuesta.p3_e * (descuento_prop / 100),
      p4:
        preciosPropuesta.p4_e - preciosPropuesta.p4_e * (descuento_prop / 100),
      p5:
        preciosPropuesta.p5_e - preciosPropuesta.p5_e * (descuento_prop / 100),
      p6:
        preciosPropuesta.p6_e - preciosPropuesta.p6_e * (descuento_prop / 100),
    });
  ...
  useEffect(() => {
    setTotalPagoAnual_prop({
      p1:
        ...
        (inputPrecioAnual_prop.precio_anual_p1 -
          inputPrecioAnual_prop.precio_anual_p1 * (descuento_prop / 100)),
      p2:
        inputConsumoAnual.consumo_anual_p2 *
        (inputPrecioAnual_prop.precio_anual_p2 -
          inputPrecioAnual_prop.precio_anual_p2 * (descuento_prop / 100)),
      p3:
        inputConsumoAnual.consumo_anual_p3 *
        (inputPrecioAnual_prop.precio_anual_p3 -
          inputPrecioAnual_prop.precio_anual_p3 * (descuento_prop / 100)),
      p4:
        inputConsumoAnual.consumo_anual_p4 *
        (inputPrecioAnual_prop.precio_anual_p4 -
          inputPrecioAnual_prop.precio_anual_p4 * (descuento_prop / 100)),
      p5:
        inputConsumoAnual.consumo_anual_p5 *
        (inputPrecioAnual_prop.precio_anual_p5 -
          inputPrecioAnual_prop.precio_anual_p5 * (descuento_prop / 100)),
      p6:
        inputConsumoAnual.consumo_anual_p6 *
        (inputPrecioAnual_prop.precio_anual_p6 -
          inputPrecioAnual_prop.precio_anual_p6 * (descuento_prop / 100)),
    });
      ...
      <section className="flex_end_section">
        ...
        <article>
          <table>
            <tbody>
              <tr>
                <th className="other_table_total_title">
